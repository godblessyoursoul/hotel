...
from bookings_widget import BookingsWidget
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        # Кнопки меню
        self.buttons = []
        for name in ["Клиенты", "Номерной фонд", "Доп. услуги", "Бронирования"]:
        ...
        self.content.addWidget(ClientsWidget())
        self.content.addWidget(PriceWidget())
        self.content.addWidget(ServicesWidget())
        self.content.addWidget(BookingsWidget())
